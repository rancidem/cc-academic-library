...
| **Convert documents** | [Features: Document Conversion](FEATURES.md#document-conversion) → [Skills: MarkItDown](SKILLS.md#12-markitdown-universal-file-to-markdown-converter) |
...
- `MarkItDown` → [SKILLS.md](SKILLS.md#12-markitdown-universal-file-to-markdown-converter)
